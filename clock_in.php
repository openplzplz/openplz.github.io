<?php
	...
	#Create shift and set clock in time to current time

	$q = "INSERT INTO 'Hours' (`clock_id`, `employee_id`, `clock_in`, `clock_out`) VALUES ('',	'$employee_ID', '".$now."','0000-00-00 00:00:00.000000');";
				$result = $db->query($q);
?>
        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="index.html"><span class="log-w3pvt">Dublin Party Hire</span> </a> <label class="sub-des">Online Store</label></h1>
                    </div>
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                ...
                <div class="col-lg-5 banner-left-info">
                    ...
                    <h3>You have clocked in. <br><span>Time : <?php echo $now; ?> </span></h3>
                    <h3> <br><span>     </span></h3>
                    <a href="clock_out.php" class="btn shop">Clock Out</a>
                    <h3> <br><span>     </span></h3>
                </div>
        ...
        <div class="container py-md-5">
            <div class="row">
                <div class="col-lg-3 footer_wthree_gridf mt-lg-5">
                    <h2><a href="index.html"><span>Dublin Party Hire</span>
                        </a> </h2>
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-sm-4 mt-3">
                    <ul class="footer_wthree_gridf_list">
                        ...
                        <li>
                            <a href="register_new_customer.php"><span class="fa fa-angle-right" aria-hidden="true"></span>Register</a>
                        </li>
                        <li>
