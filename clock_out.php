<?php
	...
	$z = "Update Hours set clock_out = '".$now."' where clock_id = ".$clock_id;
	$result = $db->query($z);
?>
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                ...
                <div class="col-lg-5 banner-left-info">
                    ...
                    <h3>You have Clocked Out. <br><span>Time : <?php echo $now; ?> </span></h3>
                    <h3> <br><span>     </span></h3>
                    <a href="sign_out.php" class="btn shop">Sign Out</a>
                    <h3> <br><span>     </span></h3>
                </div>
